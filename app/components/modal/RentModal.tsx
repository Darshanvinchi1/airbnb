...
const RentModal = () => {
  ...
  const [step, setStep] = useState(SEPTS.CATEGORY);
  ...
  if(step === SEPTS.LOCATION){
    bodyContent = (
        <div className='flex flex-col gap-8'>
            <Heading title='Where is your place located?' subtitle='Help guests find you!' />
            <CountrySelect onChange={(value) => setCustomeValue('location',value)} value={location} />
  ...
  return (
    <Modal 
        ...
        secondaryAction={step === SEPTS.CATEGORY ? undefined : onBack}
